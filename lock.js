...
lk = {
  ...
  html: '\
    ...
    <div id="lk-msg"> \
      ...
      <div class="lk-note">Разместите <a target="_blank" href="#">такую же страничку</a> на своем лиичном сайте</div> \
      </div> \
    </div> \
    </div>',
